// netsearchdlg.h : interface of the CNetSearchDlg class
//
/////////////////////////////////////////////////////////////////////////////
/**
* @file
...
class CNetSearchDlg : public CDialogImpl<CNetSearchDlg>, 
	public CWinDataExchange<CNetSearchDlg>
{
public:
	enum { IDD = IDD_DLG_NETSEARCH };

	BEGIN_MSG_MAP(CNetSearchDlg)
...
public:
	...
	int Datechk(CString str);// 检查日期

	CString Substring(CString oldstr,int i/*子串开始位置*/,int j/*子串长度*/); // 求子串 
